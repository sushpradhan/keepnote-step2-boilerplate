...
public class NoteController {
	...
	@RequestMapping(value="/add", method=RequestMethod.POST)
     public String addNote(@RequestParam("noteTitle") String noteTitle, @RequestParam("noteContent") String noteContent, @RequestParam("noteStatus") String noteStatus) {
    	 Note note=new Note();
    	 if(noteTitle.isBlank()||noteContent.isBlank()||noteStatus.isBlank())
    	 {
    		 return "index";
    	 }
    	 else
	 ...
	 */
     ...
     public String updateNote(@RequestParam("noteId") int noteId,@RequestParam("noteTitle") String noteTitle, @RequestParam("noteContent") String noteContent, @RequestParam("noteStatus") String noteStatus)
     {
    	 Note note=new Note();
